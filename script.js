$(document).ready(function() {
  const apiRoot = 'https://joanna-kotwica-prod-kodillla-tasks-6svkig.mo5.mogenius.io/v1/tasks';
  const trelloApiRoot = 'https://joanna-kotwica-prod-kodillla-tasks-6svkig.mo5.mogenius.io/v1/trello';
